...
public class FavoriteDemo extends Activity implements OnMapLongClickListener, 
    ...
    public void initUI() {
        ...
        mPop = mInflater.inflate(R.layout.activity_favorite_infowindow, null, false);
    }
    ...
    public void modifyClick(View v) {
        ...
        // 弹框修改
        LayoutInflater mInflater = getLayoutInflater();
        View modify = mInflater.inflate(R.layout.activity_favorite_alert, null);
        mdifyName = (EditText) modify.findViewById(R.id.modifyedittext);
